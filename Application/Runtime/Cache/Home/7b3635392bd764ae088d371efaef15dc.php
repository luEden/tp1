...
<div style="clear:both;"></div>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?php echo ($res["goods_name"]); echo ($res["goods_sn"]); ?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="/<?php echo ($res["goods_img"]); ?>" class="jqzoom" rel="gal1" >   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="/<?php echo ($res["goods_img"]); ?>" alt="" style="width:350px;height:350px"/>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($imgs)): $i = 0; $__LIST__ = $imgs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if(($i) == "1"): ?>class="cur"<?php endif; ?>>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?php echo ($res["goods_sn"]); ?></li>
						<li class="market_price"><span>定价：</span><em><?php echo ($res["market_price"]); ?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong><?php echo ($res["shop_price"]); ?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?php echo (date("Y-m-d",$res["addtime"])); ?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="" method="post" class="choose">
						<ul>
							<valist name="sigle" id="vo">
							<li class="product">
								<dl>
									<dt>颜色：</dt>
									<dd>
