    ...
    <form action="/admin/Attribute/edit" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            <tr>
                ...
                <td>
                    <input type='text' name='attr_name' value="<?php echo ($info["attr_name"]); ?>"  />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea name="attr_values" id="attr_values"><?php echo ($info["attr_values"]); ?></textarea>(英文逗号隔开)
                </td>
            </tr>
        </table>
        <input type="hidden" name="attr_id" value="<?php echo ($info["id"]); ?>">
...
<script type="text/javascript">
    // 默认禁用默认值的输入
    <?php if(($info["attr_input_type"]) == "1"): ?>$('#attr_values').attr('disabled',true);<?php endif; ?>
